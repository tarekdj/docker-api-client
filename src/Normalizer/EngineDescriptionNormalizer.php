...
class EngineDescriptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'TestContainersPHP\\Docker\\ApiClient\\Model\\EngineDescription';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'TestContainersPHP\\Docker\\ApiClient\\Model\\EngineDescription';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \TestContainersPHP\Docker\ApiClient\Model\EngineDescription();
        ...
        if (\array_key_exists('Plugins', $data) && $data['Plugins'] !== null) {
            ...
            foreach ($data['Plugins'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'TestContainersPHP\\Docker\\ApiClient\\Model\\EngineDescriptionPluginsItem', 'json', $context);
            }
